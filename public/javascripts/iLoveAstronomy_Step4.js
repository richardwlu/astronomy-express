...
function main() {
    ...
    //using AJAX to call our GET endpoint /astronomy for the JSON
    $.ajax({
        type: 'GET',
        url: 'http://localhost:3000/astronomy',
        success: function(data) {
            // logging data to console
            console.log(data);

            var faves = data.map(function(raw) { // This builds the faves array from raw JSON data.
                return {
